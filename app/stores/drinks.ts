...
export const useDrinksStore = defineStore('drinks', () => {
    ...
    const selectedDrink = ref<Datum | null>(null);

    async function fetchDrinks(props?: VDataTableServerOptions) {
        loading.value = true;
        ...
        const res = await useDrinksApi().getDrinks(props, activeFilters.value);
