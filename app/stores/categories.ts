...
export const useCategoriesStore = defineStore('categories', () => {
    ...
    const selectedCategory = ref<Datum | null>(null);

    async function fetchCategories(props?: VDataTableServerOptions) {
        loading.value = true;
        ...
        const res = await useCategoriesApi().getCategories(props, activeFilters.value);
