...
<template>
  ...
  >
    <template #buttons>
      <v-btn
        id="tutorial-quotations-btn-filter"
        rounded="xl"
        color="grey"
        variant="text"
        density="comfortable"
      ...
      <v-btn
        id="tutorial-quotations-btn-refresh"
        rounded="xl"
        color="grey"
        variant="text"
        icon="mdi-refresh"
      ...
      <v-btn
        id="tutorial-quotations-btn-create"
        rounded="xl"
        color="grey"
        icon="mdi-plus"
        variant="text"
    ...
    <template #item.actions="{ item }">
      <UiTableActions
        :tutorial-id="item.id === items[0]?.id ? 'tutorial-quotations' : ''"
