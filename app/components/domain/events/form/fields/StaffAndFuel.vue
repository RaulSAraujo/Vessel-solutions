...
onMounted(async () => {
  if (props.event) {
    ...
    bartenderHourlyRate.value = props.event.bartender_hourly_rate;
    numBartenders.value = props.event.num_bartenders;
    helperHourlyRate.value = props.event.helper_hourly_rate;
    numHelpers.value = props.event.num_helpers;
    fuelCostPerKm.value = props.event.fuel_cost_per_km;
  }
});
</script>
...
<template>
  <v-row dense>
    <v-col cols="12" md="4">
      ...
      >
        <UiNumberField
          id="tutorial-events-form-num-bartenders"
        ...
        <UiNumberField
          id="tutorial-events-form-bartender-hourly-rate"
    ...
    <v-col cols="12" md="4">
      ...
      >
        <UiNumberField
          id="tutorial-events-form-num-helpers"
          v-model="numHelpers"
        ...
        <UiNumberField
          id="tutorial-events-form-helper-hourly-rate"
    ...
    <v-col id="tutorial-events-form-distance" cols="12" md="2">
      <UiNumberField
        v-model="distance"
        label="Km"
    ...
    <v-col id="tutorial-events-form-fuel-cost" cols="12" md="2">
      <UiNumberField
